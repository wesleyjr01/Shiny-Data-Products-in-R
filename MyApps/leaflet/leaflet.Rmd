...
#Identical results with these commands below
# my_map = leaflet()
...
#Identical results with these commands below
# my_map = addMarkers(my_map, lat=-27.5857428, lng=-48.52421229999999, 
#              popup="Jeff Leek's Office")
# my_map

#FUll chaining command
# my_map <- leaflet() %>% 
#   addTiles() %>%
#   addMarkers(lat=39.2980803, lng=-76.5898801, 
#              popup="Jeff Leek's Office")
...
df %>% #Map Creation
  leaflet() %>%
  addTiles() %>%
  addMarkers(lat = df$latitude, lng = df$longitude, popup = paste('R$',as.character(df$Price_BRL)))
```
